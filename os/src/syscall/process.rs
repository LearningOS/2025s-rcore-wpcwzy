...
//!
use alloc::sync::Arc;
use crate::mm::{translated_mutable_pointer, PageTable, StepByOne};
...
/// sys_trace is not required in this lab.
...
pub fn sys_mmap(_start: usize, _len: usize, _prot: usize) -> isize {
    ...
    let memory_set = current_task().unwrap().get_current_memory_set();
    unsafe{
